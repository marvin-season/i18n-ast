const translation = {
  ...
  nodes: {
    ...
    start: {
      ...
      outputType: {
        selectLabel: 'Select Output Type',
        llm: 'Return variables generated by large models',
        direct_return: 'Directly answer using the set content',
      },
    },
    answer: {
      answer: 'Answer',
  ...
  runDetailDateFormat: 'MM/DD/YYYY hh:mm A',
};
